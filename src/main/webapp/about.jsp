				...
				<nav class="navbar ow-navigation">
					...
					<div class="navbar-collapse collapse" id="navbar">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a title="About Us" href="about.jsp">关于我们</a></li>
							<li><a title="Rooms" href="rooms.jsp">房间</a></li>
							<li class="dropdown">
								<a aria-expanded="false" aria-haspopup="true" role="button" class="dropdown-toggle" title="Pages" href="blog.jsp">照片廊</a>
								<i class="ddl-switch fa fa-angle-down"></i>								
							</li>
						</ul>						
					</div>
